...
export default function Home() {
    ...
    // Define sections with multiple texts and specify which ones should be animated
    const sections = [
        {
            id: 0,
        ...
        },
        {
            ...
            texts: [
                { content: "A professional-grade camera model.", animate: true },
                { content: "Designed for high-quality imaging.", animate: false },
            ],
            align: "right"
        }
    ];
                ...
                {sections.map((sec) =>
                    sec.id === section ? (
                        ...
                        >
                            ...
                            <div className="w-1/2 text-xl font-semibold text-gray-800 space-y-4">
