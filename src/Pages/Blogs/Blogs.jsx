  ...
  return (
    <div className="container mx-auto p-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {blogs.map((blog) => {
          const firstImage = blog.images?.length > 0 ? blog.images[0] : "https://via.placeholder.com/345"; // Fallback image
          ...
          return (
            <Card key={blog._id} sx={{ maxWidth: 345, boxShadow: 3, borderRadius: 2 }}>
              <CardMedia
                ...
                image={firstImage}
                alt={blog.title}
                sx={{ objectFit: "cover" }} // Ensures the image fills the area properly
              />
              <CardContent>
